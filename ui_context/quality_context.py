...
def build_quality_report_context(
    *,
    ...
    quality_rows = [
        ...
        {"field": "營收 YoY", "system_source": "FinMind/Yahoo 月營收；不採 yfinance revenueGrowth", "system_value": rev_growth, "ai_source": src("yoy"), "ai_source_url": url("yoy"), "ai_value": ai_yoy, "adopted_value": eff_rg, "adopted_source": adopt_source(rev_growth, ai_yoy, "月營收公告值", "AI補齊"), "period": latest_rev_period, "fmt": "pct", "is_stale": rev_is_stale, "notes": latest_rev_notice or ("月營收可能不是最新公告月份" if rev_is_stale else "")},
        {"field": "營收 MoM", "system_source": "FinMind 月營收", "system_value": (latest_mom_val / 100.0) if latest_mom_val is not None else None, "ai_source": src("mom"), "ai_source_url": url("mom"), "ai_value": ai_mom, "adopted_value": (latest_mom_val / 100.0) if latest_mom_val is not None else ai_mom, "adopted_source": "FinMind 月營收/AI覆蓋", "period": latest_rev_period, "fmt": "pct", "is_stale": rev_is_stale},
