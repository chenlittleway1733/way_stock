...
AI_FINANCIAL_FIELD_LABELS = {
    ...
    "roe": "ROE",
    "monthly_revenue_yoy": "最新公告月份單月營收 YoY",
    "monthly_revenue_mom": "最新公告月份單月營收 MoM",
    "earnings_growth_yoy": "獲利年增率 YoY",
    "cagr": "未來 1~3 年 CAGR",
...
def get_financials_from_ai(stock_name, stock_id, api_key, model_name="gemini-3.1-pro-preview"):
    ...
    8. 「營益率」
    9. 「ROE(股東權益報酬率)」
    10. 「法人預估未來 1~3 年獲利複合成長率 (CAGR)」：請填 cagr，不可與單月營收 YoY 混用。
    10-1. 「最新公告月份單月營收 YoY / MoM」：請分別填 monthly_revenue_yoy / monthly_revenue_mom；若只找到累計營收 YoY 或不確定口徑，monthly_revenue_yoy 請填 null。
    10-2. 「獲利年增率 YoY」：請填 earnings_growth_yoy，不可與單月營收 YoY 混用。
    ...
    【百分比轉換硬性規則｜極端 YoY 防呆】
    所有百分比欄位都必須「只轉換一次」：百分比數字 ÷ 100，不可因百分比數值大於 100% 就自動縮小兩次。
    - 5.2% 必須填 0.052
    - 52% 必須填 0.52
    - 520% 必須填 5.20
    - 730.14% 必須填 7.3014
    若新聞寫「年增 520%」，JSON 的 monthly_revenue_yoy 必須填 5.20，不可填 0.052、0.52 或 "5.20%"。
    若新聞寫「年增 730.14%」，JSON 的 monthly_revenue_yoy 必須填 7.3014，不可填 0.073、0.073014 或 "7.30%"。
    若不確定該數字是「最新公告月份單月營收 YoY」還是「累計營收 YoY」，monthly_revenue_yoy 請填 null，不可自行猜測。
    若只找到累計營收年增率，不可填入 monthly_revenue_yoy。
    ...
    JSON 格式範例：
    {{"pe": 15.2, "latest_quarter_eps": 1.35, "ttm_eps": 5.4, "fiscal_year_eps": 4.9, "forward_eps_system": null, "forward_eps_ai": 6.0, "forward_eps_consensus": 6.2, "forward_eps_fy1": 6.2, "forward_eps_fy2": 7.4, "forward_eps_fy3": 8.6, "forward_eps_fy1_year": 2026, "forward_eps_fy2_year": 2027, "forward_eps_fy3_year": 2028, "forward_eps_fy_source_note": "券商共識 FY1/FY2，FY3 為高成長情境", "trailing_eps": 5.4, "forward_eps": 6.2, "pb": 2.1, "gross_margin": 0.255, "operating_margin": 0.123, "roe": 0.15, "monthly_revenue_yoy": 5.20, "monthly_revenue_mom": 0.0855, "earnings_growth_yoy": 2.10, "cagr": 0.35, "yoy": 5.20, "target_price": 1050.0, "target_price_high": 1200.0, "target_price_avg": 1050.0, "target_price_low": 900.0, "target_price_analyst_count": 18, "target_price_rationale": "AI 伺服器需求強、毛利率改善但評價偏高", "debt_to_equity": 0.45, "mom": 0.0855, "dividend_yield": 0.032, "data_period": "2026/05/15", "free_cash_flow": 1500000000, "current_ratio": 1.85, "shares_outstanding": 2500000000, "industry_classification": {{"suggested_primary_taxon": "AI_SERVER_ODM", "suggested_display_name": "AI 伺服器 ODM / 組裝", "suggested_themes": ["AI伺服器", "資料中心"], "confidence": "medium", "reason": "主要成長動能來自 AI 伺服器，但仍需確認營收比重。", "evidence": "近期法說與新聞提及 AI 伺服器出貨動能。", "needs_manual_review": true}}, "_sources": {{"pe": {{"source": "Yahoo股市", "published_date": "2026/05/31", "source_url": "https://example.com", "note": "最新可得本益比"}}, "monthly_revenue_yoy": {{"source": "公司月營收公告/新聞", "published_date": "2026/05", "source_url": "https://example.com", "note": "最新公告月份單月營收 YoY；520% 應填 5.20"}}, "ttm_eps": {{"source": "最新財報/公開資訊觀測站", "published_date": "2026Q1", "source_url": "https://example.com", "note": "近四季 EPS 合計"}}, "forward_eps_consensus": {{"source": "券商/法人預估彙整", "published_date": "2026/05/20", "source_url": "https://example.com", "note": "{target_year} 年度 EPS 共識預估"}}, "target_price_avg": {{"source": "券商目標價彙整", "published_date": "2026/05/20", "source_url": "https://example.com", "note": "最新法人目標價均值"}}}}, "source_urls": ["https://example.com"]}}
